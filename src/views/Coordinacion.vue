<template>
    <div class="bienestar">
        ...
        <section class="encargada">
            <div class="foto">
                <img src="/images/funcionarios/fun_coordinacion.jpeg" alt="Luis Carlos Reina">
            </div>
...
.bienestar {
    ...
    min-height: 100vh;
    padding: 40px 20px;
    background-image: linear-gradient(rgba(0,0,0,0.45),rgba(0,0,0,0.45)),url("/images/coordinacion.jpg");
